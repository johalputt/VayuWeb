...
verified there, byte for byte, with CI regenerating them and failing on drift. What remains
honestly unbuilt is everything below Tauri: pin-set management, publishing, browsing, and the
window itself.
